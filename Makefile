...
ARCH            ?= arm64
CROSS_COMPILE=/home/grahame/toolchains/toolchains-gcc-10.3.0/bin/aarch64-buildroot-linux-gnu-
...
CC		= $(srctree)/toolchain/clang/host/linux-x86/clang-r416183b1/bin/clang
LD		= $(CROSS_COMPILE)ld
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
